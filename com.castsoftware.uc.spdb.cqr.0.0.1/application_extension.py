...
class ApplicationExtension(ApplicationLevelExtension):
    ...
    def end_application(self, application):
        ...
        try:             
            ...
            logging.error("SPDB : Try block executing")
        ...
        # looping through Files - Step2 For CWE 685, OMG RLB-9
        for file in files:
            fType = 0
            ...
            if fType == 1:
                ...
                scan_SCS.scan_file_SPDBviolation9_1_3(application, file, "CCPP")
                scan_SCS.scan_file_SPDBviolation12_2_5(application, file, "CCPP")
                scan_SCS.scan_file_SPDBviolation14_1_1(application, file, "CCPP")
                scan_SCS.scan_file_SPDBviolation14_1_5(application, file, "CCPP")
